...
-export([new/1, new/2, start_link/2, delete/1, delete/2, delete/3,
	 ...
	 update/3, setopts/2, clear/1, clear/2, filter/2, all/0, info/1, info/2]).
...
-spec update(atom(), any(), read_fun()) -> {ok, any()} | error.
update(Name, Key, UpdateFun) ->
  Value = UpdateFun(),
